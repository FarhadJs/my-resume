<template>
  <div @mouseenter="HoverCoverP" @mouseleave="HoverCoverP"
    ...
    <div ref="containerCover" class="absolute top-7 right-0 left-0 bottom-0 z-40 transition-all duration-500"></div>
    <div
    ...
    <div class="w-full h-full bg-black bg-opacity-60">
      <div class="w-full h-full">
        <img :src="srcImage" alt="coffee-menu" class="mt-7 full-image" draggable="false" />
      </div>
    </div>
    <a :href="props.projectUrl" target="_blank" ref="containerDetails"
